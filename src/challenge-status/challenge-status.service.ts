 ...
 * @returns {ChallengeStatus} the challenge status
 */
export async function markAsOpen(challengeId: string, playerId: string, date: Date): Promise<ChallengeStatus> {
 ...
 * @returns {ChallengeStatus} the challenge status
 */
export async function markAsFailed(challengeId: string, playerId: string, date: Date): Promise<ChallengeStatus> {
  const temp: ChallengeStatus = await this.findByChallengeIdAndPlayerId(challengeId, playerId);
 ...
 * @returns {ChallengeStatus} the challenge status
 */
export async function markAsCompleted(challengeId: string, playerId: string, date: Date): Promise<ChallengeStatus> {
  const temp: ChallengeStatus = await this.findByChallengeIdAndPlayerId(challengeId, playerId);
 ...
 * @returns {ChallengeStatus} the challenge status
 */
export async function markAsRejected(challengeId: string, playerId: string): Promise<ChallengeStatus> {
  const temp: ChallengeStatus = await this.findByChallengeIdAndPlayerId(challengeId, playerId);
 ...
 * @returns {ChallengeStatus} the challenge status
 */
export async function markAsAvailable(challengeId: string, playerId: string): Promise<ChallengeStatus> {
  const temp: ChallengeStatus = await this.findByChallengeIdAndPlayerId(challengeId, playerId);
 ...
 * @returns {ChallengeStatus} the challenge status
 */
export async function markAsHidden(challengeId: string, playerId: string): Promise<ChallengeStatus> {
  const temp: ChallengeStatus = await this.findByChallengeIdAndPlayerId(challengeId, playerId);
 ...
 * @returns {ChallengeStatus} the challenge status
 */
export async function markAsLocked(challengeId: string, playerId: string): Promise<ChallengeStatus> {
  const temp: ChallengeStatus = await this.findByChallengeIdAndPlayerId(challengeId, playerId);
